...
ROOT_URLCONF = 'Social_Library.urls'
...
WSGI_APPLICATION = 'Social_Library.wsgi.application'
...
# Email configuration for smtp4dev (local dev)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'

EMAIL_HOST = 'localhost'
EMAIL_PORT = 25  # veya smtp4dev'de gördüğün port (25, 2525 vs.)
EMAIL_USE_TLS = False
EMAIL_USE_SSL = False

EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'noreply@sosyal-kutuphanem.dev'
